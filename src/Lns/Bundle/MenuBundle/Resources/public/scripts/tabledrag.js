(function ($) {
  ...
  var themeFunctions = {
    tableDragChangedMarker: function () {
      return '<abbr class="warning tabledrag-changed" title="' + Lns.t('Changed') + '">*</abbr>';
    },
    tableDragIndentation: function () {
      return '<div class="indentation">&nbsp;</div>';
    },
    tableDragChangedWarning: function () {
      return '<div class="tabledrag-changed-warning messages messages--warning" role="alert">' + Lns.theme('tableDragChangedMarker') + ' ' + Lns.t('You have unsaved changes.') + '</div>';
    }
  };


  Lns.attachBehaviors = function() {};
  Lns.detachBehaviors = function() {};
  Lns.theme = function (arg) {
    return themeFunctions[arg].call();
  };

  Lns.t = function(string) { return string };
  ...
  *
  * Using the lns_attach_tabledrag() function, any table with weights or
  ...
  * @param tableSettings
  *   Settings for the table added via lns_add_dragtable().
  */
  Lns.tableDrag = function (table, tableSettings) {
    var self = this;
    var $table = $(table);
    ...
    if (this.indentEnabled) {
      ...
      var indent = Lns.theme('tableDragIndentation');
  ...
  * 'Lns.tableDrag.showWeight' localStorage value.
  */
  Lns.tableDrag.prototype.initColumns = function () {
  ...
  */
  Lns.tableDrag.prototype.addColspanClass = function (columnIndex) {
    return function () {
  ...
  */
  Lns.tableDrag.prototype.displayColumns = function (displayWeight) {
    if (displayWeight) {
      this.showColumns();
    }
  ...
  * Undo showColumns().
  */
  Lns.tableDrag.prototype.hideColumns = function () {
    ...
    // Change link text.
    $('.tabledrag-toggle-weight').text(Lns.t('Show row weights'));
  };
  ...
  * Undo hideColumns().
  */
  Lns.tableDrag.prototype.showColumns = function () {
    var $tables = $('table.tabledrag-processed');
    ...
    // Change link text.
    $('.tabledrag-toggle-weight').text(Lns.t('Hide row weights'));
  };

  /**
  * Find the target used within a particular row and group.
  */
  Lns.tableDrag.prototype.rowSettings = function (group, row) {
  ...
  */
  Lns.tableDrag.prototype.makeDraggable = function (item) {
    var self = this;
    var $item = $(item);
    //Add a class to the title link
    $item.find('td:first a').addClass('menu-item__link');
    // Create the handle.
    var handle = $('<a href="#" class="tabledrag-handle"><div class="handle">&nbsp;</div></a>').attr('title', Lns.t('Drag to re-order'));
  ...
  * @param Lns.tableDrag self
  *   The drag handle.
  * @param DOM item
  *   The item that that is being dragged.
  */
  Lns.tableDrag.prototype.dragStart = function (event, self, item) {
  ...
  */
  Lns.tableDrag.prototype.dragRow = function (event, self) {
    if (self.dragObject) {
  ...
  * Pointerup behavior.
  */
  Lns.tableDrag.prototype.dropRow = function (event, self) {
    ...
    if (self.rowObject !== null) {
      ...
      if (self.rowObject.changed === true) {
        ...
        if (self.changed === false) {
          $(Lns.theme('tableDragChangedWarning')).insertBefore(self.table).hide().fadeIn('slow');
          self.changed = true;
        }
      }
  ...
  */
  Lns.tableDrag.prototype.pointerCoords = function (event) {
  ...
  */
  Lns.tableDrag.prototype.getPointerOffset = function (target, event) {
  ...
  */
  Lns.tableDrag.prototype.findDropTargetRow = function (x, y) {
  ...
  */
  Lns.tableDrag.prototype.updateFields = function (changedRow) {
    for (var group in this.tableSettings) {
  ...
  */
  Lns.tableDrag.prototype.updateField = function (changedRow, group) {
  ...
  * may have had.
  */
  Lns.tableDrag.prototype.copyDragClasses = function (sourceRow, targetRow, group) {
  ...
  Lns.tableDrag.prototype.checkScroll = function (cursorY) {
  ...
  Lns.tableDrag.prototype.setScroll = function (scrollAmount) {
    var self = this;
  ...
  Lns.tableDrag.prototype.restripeTable = function () {
  ...
  */
  Lns.tableDrag.prototype.onDrag = function () {
  ...
  */
  Lns.tableDrag.prototype.onDrop = function () {
  ...
  */
  Lns.tableDrag.prototype.row = function (tableRow, method, indentEnabled, maxDepth, addClasses) {
  ...
  *   Whether we want to add classes to this row to indicate child relationships.
  */
  Lns.tableDrag.prototype.row.prototype.findChildren = function (addClasses) {
  ...
  */
  Lns.tableDrag.prototype.row.prototype.isValidSwap = function (row) {
    var $row = $(row);
    if (this.indentEnabled) {
      var prevRow, nextRow;
  ...
  */
  Lns.tableDrag.prototype.row.prototype.swap = function (position, row) {
    // Makes sure only DOM object are passed to Lns.detachBehaviors().
    this.group.forEach(function (row) {
      Lns.detachBehaviors(row, lnsSettings, 'move');
    });
    $(row)[position](this.group);
    // Makes sure only DOM object are passed to Lns.attachBehaviors()s.
    this.group.forEach(function (row) {
      Lns.attachBehaviors(row, lnsSettings);
    });
    this.changed = true;
    this.onSwap(row);
  };
  ...
  */
  Lns.tableDrag.prototype.row.prototype.validIndentInterval = function (prevRow, nextRow) {
    var $prevRow = $(prevRow);
  ...
  */
  Lns.tableDrag.prototype.row.prototype.indent = function (indentDiff) {
    ...
    for (var n = 1; n <= Math.abs(indentDiff); n++) {
      ...
      if (indentDiff < 0) {
        ...
        $group.find('td:first').prepend(Lns.theme('tableDragIndentation'));
        this.indents++;
      }
    }
    if (indentDiff) {
  ...
  */
  Lns.tableDrag.prototype.row.prototype.findSiblings = function (rowSettings) {
    var siblings = [];
  ...
  */
  Lns.tableDrag.prototype.row.prototype.removeIndentClasses = function () {
  ...
  */
  Lns.tableDrag.prototype.row.prototype.markChanged = function () {
    var marker = Lns.theme('tableDragChangedMarker');
  ...
  */
  Lns.tableDrag.prototype.row.prototype.onIndent = function () {
  ...
  */
  Lns.tableDrag.prototype.row.prototype.onSwap = function (swappedRow) {
    console.log('swap', this, swappedRow);
    return null;
  };
  ...
  $.fn.tabledrag =  function (options) {
    this.each(function() {
      console.log(Lns);
      if (!$.data(this, "tabledrag")) {
        $.data(this, "tabledrag", new Lns.tableDrag(this, options));
      }
    });
  ...
  $('table.tabledrag').each(function() {
    $(this).tabledrag(defaultSettings);
  });
